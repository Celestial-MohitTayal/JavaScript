...
//   eats: true
// };
// const orgDog =  { breed: 'Labrador', color: 'Yellow' };
// const dog = Object.create(animal);  // Set prototype to `animal`
// Object.assign(dog, orgDog); // Copy properties into `dog`

// console.log(dog.eats); // true (inherited from animal)
// console.log(dog.breed); // Labrador (copied from Object.assign)
// console.log(dog.hasOwnProperty('eats')); // false (not directly on `dog`)
// dog.breed = 'Retriever';
...
//   age: 25
// }
// // copiesObj = Object.assign({}, orgObject, thirdObj);
// copiesObj = structuredClone(orgObject);


// copiesObj.arr[0] = "Tayal"

// console.log(orgObject);

// console.log(copiesObj);
